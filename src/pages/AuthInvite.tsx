...
/**
 * /auth/invite — куда Supabase редиректит пользователя после клика
 * по invite-ссылке. К этому моменту Supabase уже создал сессию
 * (через токены в URL); нам остаётся:
 ...
 *
 * Если по этому URL прилетел уже залогиненный пользователь, у которого
 * уже есть пароль — отправляем его на главную.
 */
