  ...
  return (
    <>
      ...
      <div className="space-y-8 p-4 sm:p-8">
        ...
        {/* Plans widget уважает дашбордный фильтр квартала.
            Если выбран «Все кварталы» — агрегируем по всем; иначе только
            по выбранному. Это даёт явное соответствие между селектором в
            шапке и тем, что показано в карточках планов. */}
        <PlansSummaryWidget quarter={quarter === "all" ? undefined : quarter} />
